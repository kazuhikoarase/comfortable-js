...
(function (comfortable) {
    ...
    var createTextEditor = function (opts) {
        return {
            $el: comfortable.util.createElement('input', {
            ...
            getValue: function () {
                if (opts.dataType == 'number') {
                    var value = comfortable.NumUtil.format(comfortable.NumUtil.toNarrow(this.$el.value), opts.decimalDigits, '');
            ...
            isValid: function () {
                if (opts.dataType == 'number') {
                    return !!comfortable.NumUtil.toNarrow(this.getValue()).match(comfortable.NumUtil.re);
                }
                return true;
            }
        };
    ...
    var createSelectBox = function (opts) {
        var select = comfortable.util.createElement('select', {
        ...
        return {
            ...
            beginEdit: function (td, cell) {
                ...
                while (select.childNodes.length < options.length) {
                    select.appendChild(comfortable.util.createElement('option'));
                }
                ...
                for (; i < options.length; i += 1) {
                    ...
                    comfortable.util.set(select.childNodes[i], {
                        style: { display: '' },
        ...
        return {
            ...
            labelFunction: function (value, cell) {
                if (cell.labelFunction) {
                    ...
                    return comfortable.NumUtil.format(value, this.decimalDigits);
                }
...
(function (comfortable) {
    ...
    var TableImpl = /** @class */ (function (_super) {
        ...
        TableImpl.prototype.beforeCellSizeChangeHandler = function (event, detail) {
        ...
        TableImpl.prototype.getTargetTable = function (row, col) {
            ...
            return this.tables.filter(function (table) {
                return table.row == (row < _this.getLockRow() ? 0 : 1) &&
                    table.col == (col < _this.getLockColumn() ? 0 : 1);
            })[0];
        };
        ...
        TableImpl.prototype.render = function (visibleCell) {
            ...
            (function () {
                ...
                comfortable.util.set(_this.lockLines[0], {
                    ...
                    style: {
                        display: _this.getLockRow() == 0 ? 'none' : '', left: '0px',
                ...
                comfortable.util.set(_this.lockLines[1], {
                    ...
                    style: {
                        display: _this.getLockColumn() == 0 ? 'none' : '', top: '0px',
        ...
        TableImpl.prototype.getLockRow = function () { return this.lockRow; };
        TableImpl.prototype.getLockColumn = function () { return this.lockColumn; };
...
(function (comfortable) {
    ...
    (function (util) {
        ...
        util.$ = function (elm) {
            return {
                ...
                addClass: function (className, remove) {
                    ...
                    var classes = '';
                    (elm.getAttribute('class') || '').split(/\s+/g).
                        forEach(function (c) {
                        if (c != className) {
                            classes += ' ' + c;
                            return;
        ...
        util.closest = function (elm, opts) {
        ...
        util.moveSublist = function (list, from, length, to) {
        ...
        util.getCellId = function (row, col) {
            return row + ':' + col;
        };
        util.translate = function (val1, min1, max1, min2, max2, log) {
            var val2 = (val1 - min1) * (max2 - min2) / (max1 - min1) + min2;
            return Math.max(min2, Math.min(Math.round(val2), max2));
        };
    })(util = comfortable.util || (comfortable.util = {}));
})(comfortable || (comfortable = {}));
var comfortable;
(function (comfortable) {
    'use strict';
...
(function (comfortable) {
    ...
    comfortable.fromTemplate = function (template) {
        ...
        var table = comfortable.util.extend(comfortable.createTable(), {
            lockRow: headLength,
        ...
        table.model = comfortable.util.extend(table.model, {
            // user defines
            defaultHeaderCellRendererFactory: comfortable.createDefaultHeaderCellRendererFactory(),
            cellWidth: cellWidth,
