    ...
    var TextEditor = /** @class */ (function () {
        ...
        TextEditor.prototype.getValue = function () {
            if (this.opts.dataType == 'number') {
                var value = comfortable.util.formatNumber(comfortable.util.toNarrowNumber(this.$el.value), this.opts.decimalDigits, '');
...
(function (comfortable) {
    ...
    (function (ui) {
        ...
        var createCalTable = function (base) {
            ...
            return comfortable.util.createElement('table', { attrs: { 'class': '${prefix}-calendar' } }, [thead, tbody]);
        };
        var createCalButton = function (prev, action) {
            return comfortable.util.createElement('span', { style: { display: 'inline-block', float: prev ? 'left' : 'right' },
                ...
                on: { mousedown: function (event) { event.preventDefault(); },
                    ...
                    style: { verticalAlign: 'top' } }, [comfortable.util.createSVGElement('path', { attrs: { d: 'M3 2L13 8L3 14Z',
                            transform: prev ?
        ...
        ui.createCalendar = function (base) {
            base = base || new Date();
            ...
            var title = comfortable.util.createElement('span', { style: { flex: '1', textAlign: 'center' },
                on: { mousedown: function (event) { event.preventDefault(); },
                    click: function () {
                        base = new Date();
                        update(base);
                    } } });
            var header = comfortable.util.createElement('div', { style: { display: 'flex' } }, [prev, title, next]);
            var cal = comfortable.util.createElement('div', [header], { style: { position: 'absolute', left: '300px', top: '20px' } });
            var table = null;
...
(function (comfortable) {
    ...
    comfortable.util = {
        ...
        trimRe: /^[\s\u3000]+|[\s\u3000]+$/g,
        trim: function (value) {
            return value.replace(comfortable.util.trimRe, '');
        },
        format: function (msg) {
            var args = [];
            for (var _i = 1; _i < arguments.length; _i++) {
        ...
        DefaultFilter.prototype.createUI = function (dialog, opts, tableModel, cell) {
            ...
            var showFilterDialog = function (title) {
                ...
                var createOpUI = function (op, value) {
                    ...
                    var opBody = comfortable.util.createElement('div');
                ...
                var cfDialog = comfortable.ui.createDialog([
                    comfortable.util.createElement('div', { props: {
                            textContent: title + ' - ' + cell.label
                        },
                        style: { margin: '2px' } }),
                    op1.$el, rdGrp, op2.$el,
...
(function (comfortable) {
    ...
    comfortable.fromTemplate = function (template) {
        ...
        var TemplateTableModelImpl = /** @class */ (function (_super) {
            ...
            TemplateTableModelImpl.prototype.filterFactory = function () {
                return new comfortable.DefaultFilter();
            };
