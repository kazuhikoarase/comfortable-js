    ...
    var TextEditor = /** @class */ (function () {
        ...
        TextEditor.prototype.createDateField = function () {
            ...
            var setSelectedDate = function (date) {
                textEditor.textfield.value = comfortable.util.formatDate(comfortable.util.parseDate(date));
            };
            ...
            TemplateTableModelImpl.prototype.getCellStyleAt = function (row, col) {
                ...
                if (row < headLength) {
                    ...
                    if (this.getItemStyle) {
                        style = comfortable.util.extend(style, this.getItemStyle(this.getItemAt(itemIndex.row), { row: row, col: col, itemIndex: itemIndex }));
                    }
                }
