    ...
    comfortable.fromTemplate = function (template) {
        ...
        var TemplateTableImpl = /** @class */ (function (_super) {
            ...
            function TemplateTableImpl() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.lockColumn = template.lockColumn || 0;
                _this.enableLockColumn = true;
                // keep default value for restore.
                _this.defaultLockColumn = _this.lockColumn;
                return _this;
            }
            TemplateTableImpl.prototype.setLockColumn = function (lockColumn) {
                this.lockColumn = lockColumn;
            };
            TemplateTableImpl.prototype.getLockColumn = function () {
                return !this.enableLockColumn ? 0 : this.lockColumn;
            };
            TemplateTableImpl.prototype.getLockRow = function () { return headLength; };
...
(function (comfortable) {
    ...
    var TableImpl = /** @class */ (function (_super) {
        ...
        TableImpl.prototype.getLockRow = function () { return 0; };
        TableImpl.prototype.getLockColumn = function () { return 0; };
...
(function (comfortable) {
    ...
    (function (util) {
        ...
        // num utils
        util.numRe = /^([\+\-]?)([0-9]*)(\.[0-9]*)?$/;
        util.formatNumber = function (value, digits, s1, s2) {
            digits = digits || 0;
        ...
        util.toNarrowNumber = function (value) {
            var s = '';
