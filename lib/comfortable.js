    ...
    (function (renderer) {
        renderer.createTextEditorDateField = function (editor) {
            ...
            var showCal = function () {
                ...
                comfortable.util.$(cal.$el).addClass('${prefix}-options-frame');
    ...
    (function (renderer) {
        renderer.createTextEditorSelectBox = function (editor) {
            ...
            var showOptions = function () {
                ...
                comfortable.util.$(options.$el).addClass('${prefix}-options-frame');
...
(function (comfortable) {
    ...
    var TableImpl = (function (_super) {
        ...
        function TableImpl(model) {
            ...
            _this.document_mousedownHandler = function (event) {
                if (comfortable.util.closest(event.target, { $el: _this.$el })) {
                    return;
                }
                else if (comfortable.util.closest(event.target, { className: '${prefix}-options-frame' })) {
                    return;
                }
                else {
                    _this.editor.endEdit('doc_mousedown');
                    _this.render();
                }
            };
            _this.document_focusinHandler = function (event) {
                if (comfortable.util.closest(event.target, { $el: _this.$el })) {
                    return;
                }
                else if (comfortable.util.closest(event.target, { className: '${prefix}-options-frame' })) {
                    ...
                    _this.editor.endEdit('doc_focusin');
                    _this.render();
                }
            };
            ...
            document.addEventListener('mousedown', _this.document_mousedownHandler);
            document.addEventListener('focusin', _this.document_focusinHandler);
            return _this;
        }
