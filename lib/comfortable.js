...
(function (comfortable) {
    ...
    var TableImpl = /** @class */ (function (_super) {
        ...
        TableImpl.prototype.render = function (visibleCell) {
            ...
            (function () {
                ...
                comfortable.util.set(_this.lockLines[2], {
                    attrs: { 'class': '${prefix}-h-lock-line' },
                    style: {
                        display: _this.getLockBottom() == 0 ? 'none' : '', left: '0px',
                ...
                comfortable.util.set(_this.lockLines[3], {
                    attrs: { 'class': '${prefix}-v-lock-line' },
                    style: {
                        display: _this.getLockRight() == 0 ? 'none' : '', top: '0px',
        ...
        TableImpl.prototype.getLockBottom = function () { return 0; };
        TableImpl.prototype.getLockRight = function () { return 0; };
...
(function (comfortable) {
    ...
    comfortable.fromTemplate = function (template) {
        ...
        var TemplateTableImpl = /** @class */ (function (_super) {
            ...
            TemplateTableImpl.prototype.setLockRight = function (lockRight) {
                this.lockRight = lockRight;
            };
            TemplateTableImpl.prototype.getLockRight = function () {
                return this.lockRight;
            };
            TemplateTableImpl.prototype.getLockBottom = function () { return footLength; };
